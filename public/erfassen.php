                ...
                <form action="../controllers/submit_vehicle.php" method="post" enctype="multipart/form-data" id="vehicleForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="barcode" id="barcode" pattern="[A-Za-z0-9]{6,12}" title="6 bis 12 alphanumerische Zeichen">
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="scanner" style="height: 500px; width: 100%; background: #000;"></div> <!-- Erhöht die Höhe des Scanner-Elements -->
...
<div class="modal fade" id="cameraModal" tabindex="-1" aria-labelledby="cameraModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <video id="video" style="width: 100%; height: 500px;"></video> <!-- Erhöht die Höhe des Video-Elements -->
...
<script type="module">
    ...
    document.getElementById('cameraModal').addEventListener('shown.bs.modal', function() {
        ...
        captureButton.addEventListener('click', () => {
            ...
            // Hide the video and show a success message
